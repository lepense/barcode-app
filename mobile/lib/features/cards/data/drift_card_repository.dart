...
class DriftCardRepository implements CardRepository {
  ...
  LoyaltyCard _fromRow(Card row) {
    return LoyaltyCard(
      ...
      customCoverImagePath: row.customCoverImagePath,
      coverImageOffsetX: row.coverImageOffsetX,
      coverImageOffsetY: row.coverImageOffsetY,
  ...
  CardsCompanion _toCompanion(LoyaltyCard card) {
    ...
    return CardsCompanion(
      ...
      customCoverImagePath: Value(card.customCoverImagePath),
      coverImageOffsetX: Value(card.coverImageOffsetX),
      coverImageOffsetY: Value(card.coverImageOffsetY),
      coverImageScale: Value(card.coverImageScale),
  ...
  Future<void> updateCard(LoyaltyCard card) async {
    ...
    await _db.cardsDao.updateCard(
      Card(
        ...
        customCoverImagePath: card.customCoverImagePath,
        coverImageOffsetX: card.coverImageOffsetX,
        coverImageOffsetY: card.coverImageOffsetY,
        coverImageScale: card.coverImageScale,
